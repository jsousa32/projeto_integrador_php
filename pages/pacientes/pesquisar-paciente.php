...
<body>
    <div class="container">
        <div class="card card-register mx-auto col-6 px-0">
            <div class="card-header bg-primary text-light">Pesquisar Paciente</div>
            <div class="card-body">
                <form action="processa-pesquisa.php" method="POST">
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-12">
                                <label for="pesquisar">Pesquisar paciente no sistema</label>
                                <input type="text" name="busca" class="form-control" placeholder="Digite o nome do paciente que deseja pesquisar" required>
                            </div>
                        </div>
                    </div>
