...
<body>
    <div class="container">
        <div class="card card-register mx-auto col-6 px-0">
            <div class="card-header bg-primary">Remover itens do medicamento</div>
            <div class="card-body">
                <form action="processa-remover-itens.php" method="POST">
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-6">
                                <label for="quantidade">Quantidade a ser removida</label>
                                <input type="number" name="novaQtd" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <button class="btn btn-primary btn-block" name="remover">Remover itens do medicamento</button>
