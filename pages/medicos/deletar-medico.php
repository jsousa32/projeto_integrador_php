...
<body>
    <div class="container">
        <div class="card card-register mx-auto col-6 px-0">
            <div class="card-header bg-primary text-light">Excluir médico</div>
            <div class="card-body">
                <form action="processa-deletar-medico.php" method="POST">
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-12">
                                <label for="excluir">Deletar médico do banco de dados</label>
                                <input type="text" name="excluir" class="form-control" placeholder="Digite o ID do médico" required>
                            </div>
                        </div>
                    </div>
                    <button class="btn btn-primary mt-3 btn-block" onclick="return confirm('Deseja realmente excluir o médico?')">Excluir</button>
